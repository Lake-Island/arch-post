...
# Locale and keymap
echo "[+] Configuring Swedish locale and keyboard..."
...
# Essentials
sudo pacman -S --noconfirm git curl wget zsh neovim nano unzip zip   fzf ripgrep bat exa btop htop zoxide kitty   ttf-jetbrains-mono-nerd ttf-firacode-nerd noto-fonts noto-fonts-emoji
...
sudo pacman -S --noconfirm hyprland xdg-desktop-portal-hyprland rofi-wayland waybar   swww dunst hyprpaper wl-clipboard grim slurp
...
# Gaming
yay -S --noconfirm steam lutris heroic-games-launcher-bin   wine winetricks gamemode mangohud   dxvk-bin vkd3d proton-ge-custom-bin xpadneo-dkms-git
